...
| ImageURL                                     | <p>Link hình ảnh, chấp nhận link đuôi PNG và JPG<br>Chú ý: Lần đầu tiên đăng ký template phải gửi kèm theo hình ảnh, hình không nền.<br>Các lần đăng ký template tiếp theo cho OA đã có gửi hình ảnh trước thì không cần.</p>  |
